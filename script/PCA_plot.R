...
## then we give "s" as svdResult to the function

## 2. Read in the clin data having batch or subtypes info; the order of the samples in clinical data should be the same in expr data
## match_indx<- match(colnames(expr), clin$SampleID)

##==================================================== INPUTS:

## expr: expression data
## clin: clinical data containing info regarding biology and batch-- NOTE: It has to have a column called "SampleID", which are in the same order of the column names of the expression data
